...
async def crear_equipo_fantasy(
    ...
    """
    return equipo_fantasy_service.crear_equipo_fantasy(db, equipo, current_user.id)
...
async def obtener_equipo_fantasy(
    ...
    return equipo_fantasy_service.obtener_equipo_fantasy(db, equipo_id)
...
async def actualizar_equipo_fantasy(
    ...
    """
    return equipo_fantasy_service.actualizar_equipo_fantasy(db, equipo_id, equipo_update, current_user.id)
...
async def eliminar_equipo_fantasy(
    ...
    equipo_fantasy_service.eliminar_equipo_fantasy(db, equipo_id, current_user.id)
...
async def listar_equipos_fantasy(
    ...
    return equipo_fantasy_service.listar_equipos_fantasy(db, filtros, skip, limit)
...
async def listar_equipos_por_liga(
    ...
    return equipo_fantasy_service.listar_equipos_por_liga(db, liga_id, skip, limit)
...
async def listar_equipos_por_usuario(
    ...
    return equipo_fantasy_service.listar_equipos_por_usuario(db, usuario_id, skip, limit)
...
async def obtener_historial_cambios(
    ...
    """
    return equipo_fantasy_service.obtener_historial_cambios(db, equipo_id, skip, limit)
...
async def obtener_cambios_recientes_liga(
    ...
    return equipo_fantasy_service.obtener_cambios_recientes_liga(db, liga_id, limit)